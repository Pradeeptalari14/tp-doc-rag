...
> Python utility scanning script folders and building structured markdown document guides.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/doc-rag/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-doc-rag.git
cd tp-doc-rag
```
...
```bash
kubectl port-forward deployment/tp-doc-rag 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── doc_generator.py     # Main configuration file
```
...
---
*Generated by [Doc-RAG Studio](https://pradeeptalari14.github.io/portfolio/tools/doc-rag/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
